...
public class AuthController {
    ...
    public ResponseEntity<UsuarioDTO> register(@RequestBody RegistroDto registroDto, HttpServletRequest request) {
        return ResponseEntity.ok(authService.register(registroDto, request));
    }
