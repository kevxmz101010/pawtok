...
public class HistorialMedicoController {
    ...
    public ResponseEntity<HistorialMedicoDTO> addRegistro(
        ...
        return ResponseEntity.ok(historialMedicoService.addRegistro(body, auth.getName()));
    }
    ...
    public ResponseEntity<HistorialMedicoDTO> updateRegistro(
            ...
            @RequestBody HistorialMedicoDTO body, 
            Authentication auth) {
        return ResponseEntity.ok(historialMedicoService.updateRegistro(id, body, auth.getName()));
    }
    ...
    public ResponseEntity<Void> deleteRegistro(
            ...
            @PathVariable Long id, 
            Authentication auth) {
        historialMedicoService.deleteRegistro(id, auth.getName());
