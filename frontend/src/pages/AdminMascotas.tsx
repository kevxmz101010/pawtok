...
import { PawPrint, Shield, Search, Edit3, Trash2, Home } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen font-sans text-gray-800 bg-gray-50/50 selection:bg-[#0B84FF] selection:text-white pb-20 relative">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-28">
        ...
        <AdminHeaderNav activeTab="mascotas" title="Supervisión de Mascotas" subtitle="Monitoreo y auditoría de publicaciones registradas por los refugios" />
        ...
        <BlurFade delay={0.15} inView>
          ...
          <div className="bg-white/90 backdrop-blur-xl border border-gray-100/80 p-4 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.03)] mb-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
              ...
              {/* Distintivo de Modo Monitoreo / Supervisión (El admin no publica mascotas) */}
              <div className="px-3.5 py-2 bg-blue-50 text-[#0B84FF] border border-blue-200/70 rounded-xl text-xs font-bold flex items-center gap-1.5 shrink-0 shadow-2xs">
                <Shield size={14} />
              ...
              <table className="w-full text-left border-separate border-spacing-y-2">
                ...
                <tbody>
                  {filteredMascotas.map((m) => {
                    ...
                    const fotoUrl = formatPetImageUrl(m.imagenUrl, fallbackImg);
