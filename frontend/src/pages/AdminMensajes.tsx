            ...
            {mensajes.length > 0 ? (
              <div className="space-y-4">
                {mensajes.map((m: any) => (
                  <div
                    key={m.id}
                    className={`p-6 rounded-2xl border transition-all overflow-hidden ${
                      m.leido
                      ...
                      <div className="flex items-start gap-4 min-w-0 flex-1">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2 mb-1 flex-wrap">
                            <h3 className={`text-base font-bold break-words break-all [overflow-wrap:anywhere] ${m.leido ? 'text-gray-800' : 'text-gray-900'}`}>
                              {m.nombre}
                            </h3>
                          ...
                          <a
                            href={`mailto:${m.email}`}
                            className="text-xs font-semibold text-[#0B84FF] hover:underline mb-3 inline-block break-all"
                          >
                            {m.email}
                          </a>
                          <p className={`text-sm leading-relaxed break-words break-all [overflow-wrap:anywhere] ${m.leido ? 'text-gray-600' : 'text-gray-900 font-medium'}`}>
                            {m.mensaje}
                          </p>
                        </div>
                      </div>
